<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
	    ...
	    <!-- DateTimePicker -->
	    <script src="<%=request.getContextPath()%>/templates/datetimepicker/js/moment.min.js"></script>
	    <script src="<%=request.getContextPath()%>/templates/datetimepicker/js/daterangepicker.js"></script>
